environments {
    ...
    production {
        ...
        dataSource_chado {
            dbCreate = System.getenv("WEBAPOLLO_CHADO_DB_ACTION") ?: "update" // one of 'create', 'create-drop', 'update', 'validate', ''
            username = System.getenv("WEBAPOLLO_CHADO_DB_USERNAME")
            password = System.getenv("WEBAPOLLO_CHADO_DB_PASSWORD")

            driverClassName = System.getenv("WEBAPOLLO_CHADO_DB_DRIVER") ?: "org.postgresql.Driver"
            dialect = System.getenv("WEBAPOLLO_CHADO_DB_DIALECT") ?: "org.hibernate.dialect.PostgresPlusDialect"
